...
|-----------|----------|----------|
| Architecture & API design | Flynn | ToolIndex API shape, embedding strategy, project structure |
| Library implementation | Tron | ToolIndex, McpToolDefinition, vector search, embedding integration |
| Code review | Flynn | Review PRs, check quality, suggest improvements |
| Testing | Yori | xUnit tests, edge cases, verify behavior |
| README, docs, samples | Ram | README.md, docs/, NuGet packaging, sample apps |
